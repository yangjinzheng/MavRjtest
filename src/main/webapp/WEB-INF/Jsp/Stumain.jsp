...
<div class="easyui-layout" style="width:100%;height:100%;">
    <div region="west" split="true" title="功能区" style="width:150px;">
        <div>
            <a href="#" class="easyui-linkbutton" onclick="addTab('查询成绩','Tostuselect')">查询成绩</a><br/>
        </div>
        <div>
            <a href="#" class="easyui-linkbutton" onclick="addTab('报名二次考试','Tostusecond')">报名二次考试</a><br/>
        </div>
        <div>
            <a href="#" class="easyui-linkbutton" onclick="addTab('查询已报名考试','Tostuyb')">查询已报名考试</a><br/>
        </div>
    </div>
